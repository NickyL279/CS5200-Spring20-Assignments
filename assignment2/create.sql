...
CREATE TABLE `address` (
    ...
    `person_id` INT NULL,
    PRIMARY KEY (`id`),
    CONSTRAINT `address_person_composition` FOREIGN KEY (`person_id`) REFERENCES `person` (`id`)
	ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE `website` (
    ...
    PRIMARY KEY (`id`),    
    CONSTRAINT `wesite_developer_aggregation` FOREIGN KEY(`developer_id`)
