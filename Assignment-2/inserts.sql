USE a2;
INSERT INTO `a2`.`person` (`id`, `first_name`, `last_name`, `username`, `password`, `email`) 
...
INSERT INTO `a2`.`developer` (`id`, `developer_key`) 
VALUES (12, '4321rewq'),
(23, '5432trew'),
(34, '6543ytre');

INSERT INTO `a2`.`user` (`id`, `user_key`) 
VALUES (45, '7654fda'),
(56, '5678dfgh');

INSERT INTO `a2`.`website` (`id`, `name`, `description`, `created`, `updated`, `visits`) 
...
INSERT INTO `a2`.`website_role` (`role`, `developer_id`, `website_id`) 
...
INSERT INTO `a2`.`page` (`id`, `title`, `description`, `created`, `updated`, `views`, `website_id`) 
VALUES (123, 'Home', 'Landing page', '2018-09-05', '2018-10-08', '123434', 567),
...
INSERT INTO `a2`.`page_role` (`role`, `developer_id`, `page_id`) 
...
INSERT INTO `a2`.`widget` (`id`, `name`, `dtype`, `width`, `height`, `text`, `order`, `url`, `page_id`) 
VALUES (123, 'head123', 'heading', null, null, 'Welcome', 0, null, 123),
...
INSERT INTO `a2`.`address` (`person_id`, `street1`, `city`, `zip`, `primary`) 
VALUES (12, '123 Adam St.', 'Alton', '01234', 1),
...
INSERT INTO `a2`.`phone` (`person_id`, `phone`, `primary`) 
VALUES (12, '123-234-3456', 1),
(12, '234-345-4566', 0),
(23, '345-456-5677', 1),
(34, '321-432-5435', 1),
(34, '432-432-5433', 0),
